...
namespace HairSalon.Models
{
  public class Stylist
  {
    ...
    public Stylist(string firstName, string lastName, string phoneNumber, string email){
    ...
    public static Stylist Find(int searchID){ return AllStylists[searchID - 1]; }
  }
}
